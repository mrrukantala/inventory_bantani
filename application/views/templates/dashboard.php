...
<head>
	...
	<title><?= $title; ?> | Sistem Informasi Monitoring Persediaan Barang</title>
...
<div id="wrapper">
	...
	<ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
		...
		<a class="sidebar-brand d-flex text-white align-items-center bg-success justify-content-center" href="">
			...
			<div class="sidebar-brand-text mx-3">SI Monitoring Persediaan</div>
		</a>
		...
		<?php if (is_admin() || is_gudang()) { ?>
			...
			<!-- Nav Item - Dashboard -->
			<li class="nav-item">
				<a class="nav-link pb-0" href="<?= base_url('pengajuanbarang/pengajuan'); ?>">
					<i class="fas fa-fw fa-download"></i>
			...
			<!-- Nav Item - Dashboard -->
			<li class="nav-item">
				<a class="nav-link" href="<?= base_url('pengajuanbarang/verifikasi'); ?>">
					<i class="fas fa-fw fa-upload"></i>
			...
			<li class="nav-item">
				<a class="nav-link collapsed " href="#" data-toggle="collapse" data-target="#collapseMaster1"
				   aria-expanded="true" aria-controls="collapseMaster">
					<i class="fas fa-fw fa-folder"></i>
					<span>Stock</span>
				</a>
				<div id="collapseMaster1" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
					<div class="bg-light py-2 collapse-inner rounded">
						<h6 class="collapse-header">Master Barang:</h6>
						<a class="collapse-item" href="<?= base_url('stock'); ?>">Stock Barang</a>
						<a class="collapse-item" href="<?= base_url('stock/minmax'); ?>">Setting MinMax Barang</a>
					</div>
				</div>
			</li>
