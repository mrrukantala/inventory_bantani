        ...
        <div class="card shadow-sm border-bottom-primary">
            <div class="card-header bg-white py-3">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <a href="<?= base_url('stock/minmax') ?>" class="btn btn-sm btn-secondary btn-icon-split">
                            <span class="icon">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-5">
                        <input value="<?= set_value('jumlah_minimal'); ?>" name="jumlah_minimal" id="jumlah_minimal" type="number" class="form-control">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-5">
                        <input value="<?= set_value('jumlah_maximal'); ?>" name="jumlah_maximal" id="jumlah_maximal" type="number" class="form-control">
